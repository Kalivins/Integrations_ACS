...
require_once( get_template_directory().'/includes/advanced-custom-fields-font-awesome/acf-font-awesome.php');
...
function enqueue_bootstrap() {
  ...
  wp_enqueue_script('script', get_template_directory_uri() . '/js/jquery.min.js', 'jquery' );
}
